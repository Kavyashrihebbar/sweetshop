...
The **Sweet Shop Management System** allows customers to browse sweets and admins to manage inventory efficiently.  
It demonstrates full-stack development using **Spring Boot APIs** for the backend, **React.js** for the frontend, and **SQLite** for persistent data storage.
...
| Feature | Description |
|----------|-------------|
| 🧁 **Sweet Management** | Add, update, delete sweets (Admin only) |
| 👥 **User Authentication** | Secure login & registration with JWT |
| 📦 **API Integration** | RESTful APIs built using Spring Boot |
